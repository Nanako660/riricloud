      ...
      >
        ...
        <DialogPrimitive.Close asChild>
          <IconButton
            ...
            variant="ghost"
            size="icon-sm"
            className="absolute right-4 top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-offset-background disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground sm:right-6 sm:top-6"

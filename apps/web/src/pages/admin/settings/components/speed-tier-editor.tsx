    ...
    <div className="rounded-lg border bg-muted/20 p-4 space-y-4 min-w-0">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div className="space-y-0.5">
          <h4 className="text-sm font-semibold">速率分级色彩阶梯</h4>
          <p className="text-xs text-muted-foreground">
            根据线路或套餐的最大速率自动匹配对应颜色，在用户端卡片、管理端列表即时渲染。
          </p>
        </div>
...
function SpeedTierRow({
  ...
  const previewText = maxMbps ? `${maxMbps}M` : '最高档 / 1G+';

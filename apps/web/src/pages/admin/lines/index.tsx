        ...
        <CardContent className="p-0">
          {lines.length ? <Table>
            ...
            <TableBody>{lines.map((line, index) => <TableRow key={line.id}>
              ...
              <TableCell><div>{line.targetInbound.node.name}</div><div className="text-xs text-muted-foreground">{line.targetInbound.tag} · {line.targetInbound.type}:{line.targetInbound.port}</div></TableCell>

  ...
  return (
    <div className="space-y-2 text-xs">
      <p className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/80 px-1">
        {t('help.tocTitle', { defaultValue: 'On this page' })}
      </p>
          ...
          return (
            <a
              ...
              className={`block truncate py-1 text-xs transition-colors rounded-sm px-1.5 ${
                item.level === 3 ? 'pl-4 text-muted-foreground/70' : 'pl-1.5'
              } ${
                isActive
                  ? 'font-medium text-primary bg-primary/5 border-l-2 border-primary -ml-[2px]'
